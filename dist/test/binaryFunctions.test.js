...
const getRangeTestCases = new Map([
    [[0xFF, 3, 0], 0xF],
...
const setRangeTestCases = new Map([
    [[0, 0xFF, 7, 0], 0xFF],
    [[0, 0xFF, 15, 8], 0xFF00],
    [[0x0A0B0C0D, 0xFF, 15, 8], 0x0A0BFF0D]
]);
describe('Testing getBit function:', () => {
    getBitTestCases.forEach((expected, input) => {
...
describe('Testing setBit function:', () => {
    setBitTestCases.forEach((expected, input) => {
...
describe('Testing getRange function:', () => {
    getRangeTestCases.forEach((expected, input) => {
        test(`Input: ${input[0]}, ${input[1]}, ${input[2]}`, () => {
...
describe('Testing setRange function:', () => {
    setRangeTestCases.forEach((expected, input) => {
